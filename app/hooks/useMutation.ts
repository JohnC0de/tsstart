...
export function useBaseMutation<TVariables, TData, TError = Error>(opts: BaseMutationProps<TVariables, TData, TError>) {
...
export function useMutation<TVariables, TData, TError = Error>(opts: BaseMutationProps<TVariables, TData, TError>) {
